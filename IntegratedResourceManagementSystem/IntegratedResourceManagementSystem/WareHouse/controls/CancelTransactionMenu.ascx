<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CancelTransactionMenu.ascx.cs" Inherits="IntegratedResourceManagementSystem.WareHouse.controls.CancelTransactionMenu" %>
...
<div style ="margin-bottom: 10px;
	...
	<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" 
		Font-Size="16px" ForeColor="#CC6600" Text="Menu"></asp:Label>
</div>
...
<div style ="float:left; width: 100px; margin-right:5px;">
  <div class ="mnuIcon">
	<asp:ImageButton ID="imgBtnSKUBarcode" runat="server" 
					 ImageUrl="~/Resources/customerreturn.png" Height="42px" 
					 ToolTip="Manage Customer Return Slip" 
					 PostBackUrl="~/WareHouse/CustomerReturnSlipPanel.aspx" />
	<br />
	<asp:LinkButton ID="lnkCRS" runat="server" CssClass ="lblMenu" 
					Font-Names="Verdana" Font-Size="9px" 
					ToolTip="Manage Customer Return Slip" Font-Bold="True"
					PostBackUrl="~/WareHouse/CustomerReturnSlipPanel.aspx" 
		  ForeColor="#666666">
	   MANAGE CRS
	</asp:LinkButton>
